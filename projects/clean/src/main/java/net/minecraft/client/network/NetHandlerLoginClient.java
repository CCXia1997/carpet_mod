...
public class NetHandlerLoginClient implements INetHandlerLoginClient
{
    ...
    public void handleEncryptionRequest(SPacketEncryptionRequest packetIn)
    {
        ...
        this.statusMessageConsumer.accept(new TextComponentTranslation("connect.authorizing"));
        HttpUtil.DOWNLOADER_EXECUTOR.submit(() ->
        {
            ...
            this.statusMessageConsumer.accept(new TextComponentTranslation("connect.encrypting"));
