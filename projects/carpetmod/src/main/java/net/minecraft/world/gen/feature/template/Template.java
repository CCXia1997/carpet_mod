                    ...
                    if (template$blockinfo1 != null)
                    {
                        ...
                        if ((block == null || block != block1) && (!placementIn.getIgnoreStructureBlock() || block1 != Blocks.STRUCTURE_BLOCK) && (mutableboundingbox == null || mutableboundingbox.isVecInside(blockpos)))
                        {
                            ...
                            if (template$blockinfo1.tileentityData != null)
                            {
                                ...
                                worldIn.setBlockState(blockpos, Blocks.BARRIER.getDefaultState(), 4 | (CarpetSettings.getBool("fillUpdates")?0:1024)); // [CM]
                            }

                            if (worldIn.setBlockState(blockpos, iblockstate1, flags | (CarpetSettings.getBool("fillUpdates")?0:1024)))
                            {
