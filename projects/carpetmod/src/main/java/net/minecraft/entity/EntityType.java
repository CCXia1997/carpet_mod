...
public class EntityType<T extends Entity>
{
    ...
    @Nullable
    public T spawn(World worldIn, @Nullable NBTTagCompound nbt, @Nullable ITextComponent customName, @Nullable EntityPlayer player, BlockPos pos, boolean p_208050_6_, boolean p_208050_7_)
    {
        T t = this.create(worldIn, nbt, customName, player, pos, p_208050_6_, p_208050_7_);
        worldIn.spawnEntity(t);
        return t;
    }

    @Nullable
    public T create(World worldIn, @Nullable NBTTagCompound nbt, @Nullable ITextComponent customName, @Nullable EntityPlayer player, BlockPos pos, boolean p_210761_6_, boolean p_210761_7_)
    {
        ...
        else
        {
            ...
            applyItemNBT(worldIn, player, t, nbt);
            return t;
        }
    }
